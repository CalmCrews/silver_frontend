...
const SignIn = () => {
  ...
  return (
    <Container>
      <TitleContainer>
        <p>모임원들과 모여<br/>여기서 더 저렴하게!</p>
        <h1 style={{margin: "15px"}}>모 여</h1>
      </TitleContainer>
      <SignInForm />
      <div style={{display: "flex", fontSize: "1rem", marginBottom: "35px"}}>
        <p style={{color: "#3a3a3a"}}>아직 회원이 아니신가요?&nbsp;</p>
        <a href="/signup/id" style={{color: "#a394ff", textDecorationColor: "#a394ff", textUnderlineOffset: "4px"}}>회원가입하기</a>
      </div>
      <Divider variant="middle" sx={{width: "100%", borderBottomWidth: "2px"}}/>
      <SocialLoginTitle>간편 로그인</SocialLoginTitle>
      <p style={{color: "#3a3a3a"}}>SNS 계정을 이용해 로그인 할 수 있어요</p>
      <div style={{ margin: "27px", width: "250px"}}>
        <SocialLoginButton sx={{padding: "0", marginBottom: "10px"}} onClick={handleKakaoLogin}>
          <img src={Kakao} alt="Kakao_login_button" style={{width: "100%"}}/>
        </SocialLoginButton>
        <SocialLoginButton sx={{padding: "0"}}>
          <img src={Naver} alt="Naver_login_button" style={{width: "100%"}} onClick={handleNaverLogin}/>
        </SocialLoginButton>
      </div>
    </Container>
  );
